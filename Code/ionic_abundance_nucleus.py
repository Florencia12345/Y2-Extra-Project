...
den = 214.07  # 214.07
obs = pn.Observation()
obs.readData('/Users/vivian/Desktop/Undergrad Study/Y2 Physics/Extra Project/Code/Observation_nucleus.dat', fileFormat='lines_in_rows', err_default=0.05)
...
for line in sorted(ab_dict):
    ...
    print('{:10} {:.8f}'.format(line, ab_dict[line][0]))
